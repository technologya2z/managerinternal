  ...
  security:
    oauth2:
      client:
        provider:
          oidc:
            issuer-uri: https://connect-internal.uat.pvcb.vn/auth/realms/pvcombank-internal
        registration:
          oidc:
            client-id: web_app
...
To build the final jar and optimize the managerInternal application for production, run:

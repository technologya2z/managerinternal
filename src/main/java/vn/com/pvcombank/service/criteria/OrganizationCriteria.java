...
/**
 * Criteria class for the {@link vn.com.pvcombank.domain.Organization} entity. This class is used
 * in {@link vn.com.pvcombank.web.rest.OrganizationResource} to receive all the possible filtering options from
...
public class OrganizationCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, code, description, address, phoneNumber, departmentId, areaId, distinct);
    }

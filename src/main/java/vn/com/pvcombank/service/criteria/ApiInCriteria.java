...
/**
 * Criteria class for the {@link vn.com.pvcombank.domain.ApiIn} entity. This class is used
 * in {@link vn.com.pvcombank.web.rest.ApiInResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /api-ins?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
public class ApiInCriteria implements Serializable, Criteria {
    ...
    public ApiInCriteria() {}

    public ApiInCriteria(ApiInCriteria other) {
    ...
    @Override
    public ApiInCriteria copy() {
        return new ApiInCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ApiInCriteria that = (ApiInCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, dateConnect, description, apiInfoId, applicationId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "ApiInCriteria{" +
            (id != null ? "id=" + id + ", " : "") +

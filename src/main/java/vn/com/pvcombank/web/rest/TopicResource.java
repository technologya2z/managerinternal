...
import vn.com.pvcombank.service.TopicQueryService;
...
/**
 * REST controller for managing {@link vn.com.pvcombank.domain.Topic}.
 */
@RestController
@RequestMapping("/api")
public class TopicResource {
    ...
    public ResponseEntity<Topic> getTopic(@PathVariable Long id) {
        ...
        Optional<Topic> topicDTO = topicService.findOne(id);

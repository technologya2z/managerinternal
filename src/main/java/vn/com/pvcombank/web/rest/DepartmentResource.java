...
import vn.com.pvcombank.service.DepartmentQueryService;
import vn.com.pvcombank.service.DepartmentService;
...
/**
 * REST controller for managing {@link vn.com.pvcombank.domain.Department}.
 */
@RestController
@RequestMapping("/api")
public class DepartmentResource {
    ...
    public ResponseEntity<Department> getDepartment(@PathVariable Long id) {
        ...
        Optional<Department> departmentDTO = departmentService.findOne(id);

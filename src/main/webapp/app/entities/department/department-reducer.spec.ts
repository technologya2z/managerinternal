...
//     it('dispatches FETCH_DEPARTMENT_LIST actions', async () => {
...
//     it('dispatches FETCH_DEPARTMENT actions', async () => {
//       const expectedActions = [
//         {
...
//     it('dispatches CREATE_DEPARTMENT actions', async () => {
//       const expectedActions = [
//         {
...
//     it('dispatches UPDATE_DEPARTMENT actions', async () => {
//       const expectedActions = [
//         {
...
//     it('dispatches PARTIAL_UPDATE_DEPARTMENT actions', async () => {
//       const expectedActions = [
//         {
...
//     it('dispatches DELETE_DEPARTMENT actions', async () => {
//       const expectedActions = [
//         {

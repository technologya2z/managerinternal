...
export const searchEntitiesTopicIn = createAsyncThunk(
  'topicIn/fetch_entity_list',
...
export const TopicInSlice = createEntitySlice({
  ...
  extraReducers(builder) {
    builder
      ...
      .addMatcher(isFulfilled(getEntities, searchEntitiesTopicIn, getEntitiesTopicId), (state, action) => {
      ...
      .addMatcher(isPending(getEntities, getEntitiesTopicId, searchEntitiesTopicIn, getEntity), state => {

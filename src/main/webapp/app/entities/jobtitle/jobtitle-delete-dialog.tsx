...
import { getEntity, deleteEntity } from './jobtitle.reducer';

export const JobtitleDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="cmspApp.jobtitle.delete.question">
        <Translate contentKey="cmspApp.jobtitle.delete.question" interpolate={{ id: jobtitleEntity.name }}>

...
// import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './partner-1.reducer';
...
//     it('dispatches FETCH_PARTNER1_LIST actions', async () => {
...
//     it('dispatches FETCH_PARTNER1 actions', async () => {
//       const expectedActions = [
//         {
...
//     it('dispatches CREATE_PARTNER1 actions', async () => {
//       const expectedActions = [
//         {
...
//     it('dispatches UPDATE_PARTNER1 actions', async () => {
//       const expectedActions = [
//         {
...
//     it('dispatches PARTIAL_UPDATE_PARTNER1 actions', async () => {
//       const expectedActions = [
//         {
...
//     it('dispatches DELETE_PARTNER1 actions', async () => {
//       const expectedActions = [
//         {
